...
// LED_ALL_ON/OFF
#define LED_ALL_ON  P2->OUT|=0b00000111
#define LED_ALL_OFF P2->OUT&=0b11111000

// LED_SET by specific color
#define LED_SET_K   P2->OUT=(P2->OUT&0b11111000)|0b00000000
#define LED_SET_R   P2->OUT=(P2->OUT&0b11111000)|0b00000001
#define LED_SET_G   P2->OUT=(P2->OUT&0b11111000)|0b00000010
#define LED_SET_B   P2->OUT=(P2->OUT&0b11111000)|0b00000100
#define LED_SET_C   P2->OUT=(P2->OUT&0b11111000)|0b00000110
#define LED_SET_M   P2->OUT=(P2->OUT&0b11111000)|0b00000101
#define LED_SET_Y   P2->OUT=(P2->OUT&0b11111000)|0b00000011
#define LED_SET_W   P2->OUT=(P2->OUT&0b11111000)|0b00000111
...
// Tachometer 0 1
#define TACHOMETER_L_A_TF      ((P10->IN&0b00100000)>>5)
#define TACHOMETER_R_A_TF      ((P10->IN&0b00010000)>>4)
#define TACHOMETER_L_B_TF      ((P5->IN&0b00000100)>>2)
#define TACHOMETER_R_B_TF      ((P5->IN&0b00000001)>>0)
