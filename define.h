...
#define SET_SYSTICK_FOR_50KHZ           SysTick->CTRL=0,SysTick->LOAD=48*20-1,SysTick->VAL=0,SysTick->CTRL=0x00000005;
...
#define REFLECTANCE_LED_ALL_ON          P5->OUT|=0b00001000,P9->OUT|=0b00000100
#define REFLECTANCE_LED_ALL_OFF         P9->OUT|=0b00000100,P9->OUT&=0b11111011
